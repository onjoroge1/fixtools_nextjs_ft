const unitsDB = [
  ...
  {
    id: 'volumeConversion',
    title: 'Convert any of volume unit into your favourite units.',
    description: 'Convert volume units including liters, gallons, cups, milliliters, and more.',
    convertOptions: [
      'milliliter',
      'liter',
      'cubicMeter',
  ...
  },
  {
    ...
    convertOptions: ['milliwatt', 'watt', 'kilowatt', 'megawatt', 'gigawatt', 'horsepower', 'metricHorsepower', 'btuPerHour', 'footPoundPerSecond', 'caloriePerSecond'],
  },
  {
    id: 'lengthConversion',
