...
export default function WordToPDF() {
  ...
  const canonicalUrl = `${siteHost}/pdf/word-to-pdf`;
  ...
  const convertWordToPDF = async () => {
    ...
    const requirement = checkPaymentRequirement(wordFile.size, 1);
    const passData = typeof window !== 'undefined' ? localStorage.getItem('processingPass') : null;
    let hasValidPass = false;
    ...
    try {
      ...
      // Call API route
      const response = await fetch('/api/pdf/convert-to-pdf', {
        method: 'POST',
        body: formData,
      });
  ...
  const structuredData = {
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Upload your Word document (.docx or .doc) using the upload button or drag and drop it into the designated area. Click Convert to PDF to process your file. Once conversion is complete, download your PDF document. Files up to 100MB are free, larger files require a Processing Pass."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, Word to PDF conversion is free for files up to 100MB. For larger files or batch processing, a Processing Pass ($2.99 for 24 hours) is required. This pass gives you access to files up to 200MB and unlimited batch processing."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Free tier supports Word documents up to 100MB. With a Processing Pass, you can convert files up to 200MB. Files larger than 200MB are not currently supported."
          }
        },
        {
          "@type": "Question",
          "name": "Is my Word document data secure?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, all Word document processing happens on secure servers. Your files are processed and immediately deleted after conversion. We never store your documents or share them with third parties."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Our tool supports both .docx (Word 2007 and later) and .doc (Word 97-2003) formats. The converter preserves text content and basic formatting from your Word documents."
          }
        },
        {
          "@type": "Question",
          "name": "What's the quality of the converted PDF?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Our converter preserves text content and basic formatting from Word documents. The PDF output maintains proper page layout, margins, and text formatting. Complex formatting like tables and images are preserved as much as possible."
          }
        },
        {
          "@type": "Question",
          "name": "Can I convert Word documents with images?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, our converter processes Word documents with images. Images are preserved in the PDF output, though complex layouts may require adjustment. For best results with image-heavy documents, consider using our Image to PDF tool for individual images."
          }
        },
        {
          "@type": "Question",
    ...
    softwareApp: {
      ...
      "operatingSystem": "Any",
      "description": "Convert Word documents (.docx, .doc) to PDF format online. Preserve formatting and layout for easy sharing and printing. Free for files up to 100MB.",
      "offers": {
        "@type": "Offer",
        "price": "0",
        "priceCurrency": "USD"
    ...
    howTo: {
      ...
      "description": "Step-by-step guide to convert Word documents to PDF format online using FixTools Word to PDF converter.",
      "step": [
        {
          "@type": "HowToStep",
          "name": "Upload your Word document",
          "text": "Click the upload button or drag and drop your Word document (.docx or .doc) into the upload area. Files up to 100MB are free. Larger files require a Processing Pass.",
          "position": 1
        },
        {
          "@type": "HowToStep",
          "name": "Convert to PDF",
          "text": "Click Convert to PDF to process your file. The tool will preserve text and formatting from your Word document and create a PDF file.",
          "position": 2
        },
        {
          "@type": "HowToStep",
          "name": "Download your PDF document",
          "text": "Once conversion is complete, click Download to save your PDF document to your computer. You can then open it in any PDF viewer or share it easily.",
          "position": 3
        }
      ]
    },
  ...
  return (
    <>
      <Head>
        ...
        <title>Word to PDF Converter - Free Online DOCX to PDF Tool | FixTools</title>
        <meta name="title" content="Word to PDF Converter - Free Online DOCX to PDF Tool | FixTools" />
        <meta name="description" content="Convert Word documents (.docx, .doc) to PDF format online for free. Preserve formatting and layout for easy sharing and printing. Free for files up to 100MB." />
        <meta name="keywords" content="word to pdf, convert word to pdf, docx to pdf, word to pdf converter, word to pdf online, convert docx to pdf, doc to pdf, word pdf converter, microsoft word to pdf" />
        ...
        <meta property="og:title" content="Word to PDF Converter - Free Online Tool" />
        <meta property="og:description" content="Convert Word documents (.docx, .doc) to PDF format online for free. Preserve formatting and layout." />
        <meta property="og:image" content={`${siteHost}/images/og-word-to-pdf.png`} />
        <meta property="og:site_name" content="FixTools" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content={canonicalUrl} />
        <meta property="twitter:title" content="Word to PDF Converter - Free Online Tool" />
        <meta property="twitter:description" content="Convert Word documents (.docx, .doc) to PDF format online for free." />
        <meta property="twitter:image" content={`${siteHost}/images/og-word-to-pdf.png`} />
      ...
      <style jsx global>{`
        ...
        .word-to-pdf-page *,
        .word-to-pdf-page *::before,
        .word-to-pdf-page *::after {
        ...
        .word-to-pdf-page input,
        .word-to-pdf-page textarea,
        .word-to-pdf-page select {
          font-family: inherit;
        }
      `}</style>

      <div className="word-to-pdf-page bg-[#fbfbfc] text-slate-900 min-h-screen">
        {/* Header */}
        ...
        <nav className="mx-auto max-w-6xl px-4 py-3" aria-label="Breadcrumb">
          <ol className="flex items-center gap-2 text-sm text-slate-600">
            ...
            <li className="flex items-center gap-2">
              <span className="text-slate-400">/</span>
              <span className="font-semibold text-slate-900">Word to PDF</span>
            </li>
          </ol>
        </nav>
          ...
          <div className="grid md:grid-cols-12 gap-8 items-center">
            <div className="md:col-span-7">
              ...
              <p className="mt-4 max-w-xl text-base leading-relaxed text-slate-600 md:text-lg md:leading-relaxed">
                Our <strong>Word to PDF converter</strong> helps you convert Word documents (.docx, .doc) to PDF format instantly. 
                Preserve formatting and layout for easy sharing, printing, and archiving. 
                ...
                <div className="group rounded-3xl border-2 border-slate-200 bg-gradient-to-br from-white to-slate-50 p-6 shadow-lg transition-all duration-300 hover:border-red-300 hover:shadow-xl hover:-translate-y-1">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-lg font-bold text-slate-900">Professional PDF Format</h4>
                      <p className="mt-1 text-sm text-slate-600 leading-relaxed">
                        Convert Word documents to professional PDF files. Preserve formatting, layout, and structure for consistent viewing across all devices and platforms.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group rounded-3xl border-2 border-slate-200 bg-gradient-to-br from-white to-slate-50 p-6 shadow-lg transition-all duration-300 hover:border-blue-300 hover:shadow-xl hover:-translate-y-1">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="mt-1 text-sm text-slate-600 leading-relaxed">
                        All Word document processing happens on secure servers. Your files are processed and immediately deleted after conversion. We never store your documents.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group rounded-3xl border-2 border-slate-200 bg-gradient-to-br from-white to-slate-50 p-6 shadow-lg transition-all duration-300 hover:border-emerald-300 hover:shadow-xl hover:-translate-y-1">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="mt-1 text-sm text-slate-600 leading-relaxed">
                        Convert Word documents to PDF in seconds. Small files process in 5-10 seconds, larger files in 30-60 seconds. Processing Pass holders get priority.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section id="tool" className="mx-auto max-w-6xl px-4 pb-12 pt-2">
          <div className="rounded-3xl border border-slate-200 bg-white p-5 md:p-7" style={{ boxShadow: '0 12px 40px rgba(2, 6, 23, 0.08)' }}>
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
              <div>
                <h2 className="text-xl font-semibold text-slate-900">Word to PDF Converter</h2>
                <p className="mt-1 text-sm text-slate-600">Upload your Word document and convert to PDF format</p>
              </div>
              ...
              <div className="relative">
                ...
                >
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <div>
                      <span className="text-sm font-semibold text-slate-700">Click to upload Word document</span>
                      <p className="text-xs text-slate-500 mt-1">or drag and drop (.docx or .doc)</p>
                    </div>
                    {wordFile && (
                      <p className="text-xs text-slate-600 mt-2">
                        {wordFile.name} ({formatFileSizeDisplay(wordFile.size)})
                        {wordFile.size > 100 * 1024 * 1024 && (
            ...
            {convertedFile && (
              <div className="space-y-4">
                ...
                >
                  📥 Download PDF Document ({convertedFile.filename})
                </button>
              </div>
            )}
          </div>
        ...
        <section className="mx-auto max-w-6xl px-4 pb-12">
          <div className="rounded-3xl border border-slate-200 bg-white p-6 md:p-10" style={{ boxShadow: '0 12px 40px rgba(2, 6, 23, 0.08)' }}>
            ...
            <div className="inline-flex items-center gap-2 mb-4">
              ...
              <h2 className="text-3xl font-bold text-slate-900">What is Word to PDF Conversion?</h2>
            </div>
            
            <div className="prose prose-slate max-w-none">
              <p className="text-base text-slate-700 leading-relaxed mb-4">
                <strong>Word to PDF conversion</strong> is the process of converting Word documents (.docx or .doc) into PDF (Portable Document Format) files. 
                This conversion preserves text, formatting, and layout from Word documents, making them viewable consistently across all devices and platforms. 
                ...
                PDFs are document formats designed for consistent viewing and printing across different platforms.
              </p>

              <p className="text-base text-slate-700 leading-relaxed mb-4">
                Converting Word documents to PDF format is essential when you need to share documents that maintain consistent formatting, protect content from editing, 
                or ensure documents display correctly on any device. Unlike Word documents, which may display differently depending on the software and fonts available, 
                PDFs preserve exact formatting and layout, making them ideal for professional documents, contracts, reports, and presentations. 
                Our Word to PDF converter uses advanced document processing to preserve formatting and structure during conversion.
              </p>

              <p className="text-base text-slate-700 leading-relaxed mb-4">
                Our Word to PDF converter processes files securely on our servers using mammoth for Word document parsing and pdf-lib for PDF creation. 
                The conversion preserves text content, maintains formatting, and creates a professional PDF document. 
              ...
              <div className="grid md:grid-cols-2 gap-6 my-6">
                <div className="rounded-2xl border-2 border-slate-200 bg-slate-50 p-5">
                  ...
                  <p className="text-sm text-slate-700 leading-relaxed mb-3">
                    Word documents may display differently on different devices and software. Formatting can change, fonts may not be available, and layout can shift.
                  </p>
                  <div className="bg-white p-3 rounded-lg border border-slate-200">
                    <p className="text-xs text-slate-600 font-mono">document.docx (2.5 MB)</p>
                    <p className="text-xs text-slate-500 mt-1">Formatting may vary</p>
                  </div>
                </div>
                ...
                <div className="rounded-2xl border-2 border-red-200 bg-red-50 p-5">
                  ...
                  <p className="text-sm text-slate-700 leading-relaxed mb-3">
                    PDF documents display consistently across all devices and platforms. Formatting is preserved, layout is fixed, and documents look professional.
                  </p>
                  <div className="bg-white p-3 rounded-lg border border-red-200">
                    <p className="text-xs text-slate-600 font-mono">document.pdf</p>
                    <p className="text-xs text-slate-500 mt-1">Consistent formatting</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="mx-auto max-w-6xl px-4 pb-12">
          <div className="rounded-3xl border-2 border-slate-200 bg-gradient-to-br from-slate-50 to-white p-8 md:p-10" style={{ boxShadow: '0 12px 40px rgba(2, 6, 23, 0.08)' }}>
            ...
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-slate-900 mb-3">Word to PDF Impact</h2>
              <p className="text-slate-600 max-w-2xl mx-auto">
                Real data showing the benefits of converting Word documents to PDF
              </p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="text-center p-6 rounded-2xl bg-white border-2 border-red-200 shadow-lg">
                <div className="text-5xl font-extrabold text-red-600 mb-2">350K</div>
              ...
              <div className="text-center p-6 rounded-2xl bg-white border-2 border-purple-200 shadow-lg">
                <div className="text-5xl font-extrabold text-purple-600 mb-2">PDF</div>
                <div className="text-sm font-semibold text-slate-900 mb-1">Output Format</div>
                <div className="text-xs text-slate-600">Professional PDF</div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-700 leading-relaxed">
                    According to <a href="https://www.adobe.com/acrobat/online/word-to-pdf.html" target="_blank" 
                    rel="noopener noreferrer nofollow" className="text-red-700 hover:text-red-800 font-semibold underline">Adobe</a>, 
                    Word to PDF conversion is one of the most requested document conversion operations. Our server-side processing ensures 
                    accurate formatting preservation and layout consistency, making it ideal for business documents, academic papers, and 
                    professional content that needs consistent presentation.
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* Why Use Word to PDF Section */}
        <section className="mx-auto max-w-6xl px-4 pb-12">
          <div className="rounded-3xl border border-slate-200 bg-white p-6 md:p-10" style={{ boxShadow: '0 12px 40px rgba(2, 6, 23, 0.08)' }}>
            
            <div className="inline-flex items-center gap-2 mb-4">
              <div className="h-1 w-8 bg-gradient-to-r from-red-500 to-orange-500 rounded-full"></div>
              <h2 className="text-3xl font-bold text-slate-900">Why Use Word to PDF Converter?</h2>
            </div>
            
            <p className="text-lg text-slate-600 mb-6 leading-relaxed">
              Converting Word documents to PDF format offers numerous benefits for sharing, printing, and archiving. 
              Here are the key advantages of using our Word to PDF converter:
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="group p-6 rounded-2xl border-2 border-slate-200 bg-gradient-to-br from-white to-slate-50 hover:border-red-300 transition-all duration-300 hover:shadow-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-700 leading-relaxed">
                      PDF documents maintain exact formatting and layout across all devices and platforms. Unlike Word documents, which may display differently, 
                      PDFs ensure your documents look exactly as intended, regardless of the software or device used to view them.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="group p-6 rounded-2xl border-2 border-slate-200 bg-gradient-to-br from-white to-slate-50 hover:border-blue-300 transition-all duration-300 hover:shadow-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-700 leading-relaxed">
                      PDF files can be opened on any device with any PDF viewer, including smartphones, tablets, and computers. 
                      No special software is required, making PDFs the ideal format for sharing documents with others who may not have Microsoft Word.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="group p-6 rounded-2xl border-2 border-slate-200 bg-gradient-to-br from-white to-slate-50 hover:border-emerald-300 transition-all duration-300 hover:shadow-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-2">Professional Presentation</h3>
                    <p className="text-sm text-slate-700 leading-relaxed">
                      PDF format is the standard for professional documents, contracts, reports, and presentations. Converting Word to PDF ensures 
                      your documents maintain a professional appearance and are ready for sharing, printing, or archiving.
                    </p>
                  </div>
                </div>
              </div>
